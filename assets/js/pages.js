...
async function handleCVUpload(event) {
    ...
    try {
        ...
        if (user.tier === 'premium' && response.premium_analysis) {
            if (response.premium_analysis.ats_score) {
                resultsHTML += `
                    <div style="background: rgba(168, 85, 247, 0.15); padding: 16px; border-radius: 8px;">
                        ...
                        <div style="font-size: 24px; font-weight: 700; color: #a855f7;">${response.premium_analysis.ats_score}%</div>
                    </div>
                `;
            }
            
            if (response.premium_analysis.salary_range) {
                resultsHTML += `
                    <div style="background: rgba(249, 115, 22, 0.15); padding: 16px; border-radius: 8px;">
                        ...
                        <div style="color: #f97316; font-weight: 600;">${response.premium_analysis.salary_range}</div>
                    </div>
                `;
            }
        }
